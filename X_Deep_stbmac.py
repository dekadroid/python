...
╰─⍟ \33[92m"""+str(hitr)+"""𝗫 𝗗𝗲𝗲𝗽 """ +str(hitc)+"""  \33[0m\33[91mRᴜɴ➢"""+str(oran)+"""%   \33[0m
""")
...
"[■■■■■■■■■■■■■■■]"]
	...
	time.sleep(0.2)
	sys.stdout.write("\r"'\33[91m𝗫 𝗗𝗲𝗲𝗽\33[0m'+ animation[ i % len(animation)]+'    \33[91mPʀᴏxCʜᴇᴄᴋ️   \33[0m')
	sys.stdout.flush()
	#print('\n')			
...
╭─➤𝗫 𝗗𝗲𝗲𝗽 - Sharing ⭕️ 
├◉𝐒𝐜𝐚𝐧𝐁𝐲 ➤ """+str(nickn)+"""
├◉𝐒𝐜𝐚𝐧𝐃𝐚𝐭𝐞 ➤"""+str(time.strftime('%d-%m-%Y'))+"""
├◉𝐑𝐞𝐚𝐥 ➤ """+str(reall)+"""
...
if not os.path.exists(hits):
    os.mkdir(hits)
Dosyab=hits+"XDeep_"+dosyaadi+"@Feyzo.txt"
hitsay=0
say=1
def yax(hits):
    dosya=open(Dosyab,'a+') 
